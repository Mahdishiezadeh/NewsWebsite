...
namespace NewsWebsite.Common
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// این متد یک آرایه دریافت میکند و یک کاراکتر
        /// و اعضای آن آرایه را به کاراکتر میچسباند
        /// و رشته را بازگشت میدهد
        /// </summary>
        ...
        /// <summary>
        /// در این متد روزهای هفته را دریافت و یک عدد را به ما پاس میدهد
        /// مثلا برای روز شنبه عدد 0 را پاس میدهد
        /// </summary>
        ...
        public static int GetNumOfWeek(this string week)
        {
            ...
            ///در این خط ما ایندکس آرایه را به ما بازگشت میدهد مثلا یکشنبه ایندکس 1 دارد
