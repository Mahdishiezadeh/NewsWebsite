...
namespace NewsWebsite.Services.Identity
{
    public class ApplicationUserManager : UserManager<User>, IApplicationUserManager
    {
        ...
        /// <summary>
        /// متد جدید برای نمایش اطلاعات کاربران 
        /// که عملیات سورت و سرچ  و پیجینگ را انجام میدهد 
        /// </summary>
        /// <param name="offset"></param>
        /// <param name="limit"></param>
        /// <param name="firstnameSortAsc"></param>
        /// <param name="lastnameSortAsc"></param>
        /// <param name="emailSortAsc"></param>
        /// <param name="usernameSortAsc"></param>
        /// <param name="registerDateTimeSortAsc"></param>
        ...
        /// <summary>
        /// این متد برای بررسی نام آواتار است که کاربر وارد میکند 
        /// و طی آن بررسی مکینیم تکراری نباشد و اگر بود تغییر دهیم 
        /// </summary>
